...
class FAQ(models.Model):
    ...
    respuesta = models.TextField(verbose_name="Respuesta", blank=True)
    # Para categorizar, aunque no es obligatorio, es útil
    categoria = models.CharField(max_length=50, default='General', verbose_name="Categoría", blank=True)
